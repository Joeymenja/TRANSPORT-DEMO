...
const DocumentsScreen: React.FC<DocumentsScreenProps> = ({ onBack }) => {
  ...
  const handleSmartScan = async () => {
    ...
    try {
      ...
      // In a real app, we'd pass an actual image part. Here we simulate analysis of a medical card.
      ...
      <div className="fixed inset-0 z-[100] bg-black flex flex-col">
        ...
        <div className="flex-1 relative flex items-center justify-center p-12">
           <div className="w-full aspect-[3/2] border-2 border-white/30 rounded-3xl relative overflow-hidden">
              ...
              <div className="absolute top-0 left-0 right-0 h-1 bg-teal-400 shadow-[0_0_15px_rgba(56,189,248,0.8)] animate-[scan_3s_ease-in-out_infinite]" />
              <style>{`
                @keyframes scan {
                  0% { top: 0; }
                  50% { top: 100%; }
        ...
        {scanResult && (
          <div className="absolute inset-0 z-[110] bg-white p-8 flex flex-col justify-center animate-in zoom-in-95 duration-300">
             ...
             <div className="space-y-4 bg-gray-50 p-6 rounded-[32px] border border-gray-100 mb-10">
                ...
                <div className="flex justify-between items-center">
                   ...
                   <span className="text-sm font-black text-teal-600">{scanResult.expiry || 'May 05, 2026'}</span>
                </div>
             </div>
