  ...
  return (
    <div className="fixed inset-0 z-[120] bg-gray-900 flex flex-col items-center justify-between p-12 text-center overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-20">
         <div className={`w-96 h-96 bg-teal-500 rounded-full blur-[100px] transition-all duration-700 ${isActive ? 'scale-150 animate-pulse' : 'scale-50'}`} />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center gap-12">
        ...
        <div className="space-y-4">
           ...
           <p className="text-teal-200/60 font-medium max-w-xs mx-auto text-sm leading-relaxed px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
         <div className="bg-white/5 border border-white/10 rounded-[32px] p-6 backdrop-blur-xl mb-8">
            <p className="text-[10px] font-black text-teal-400 uppercase tracking-[0.2em] mb-4">Transcription</p>
