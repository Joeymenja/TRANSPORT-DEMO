...
import { ArrowLeft, Search, Filter, Calendar, MapPin, ChevronRight, FileText, Download, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-[65] bg-gray-50 flex flex-col max-w-md mx-auto h-screen">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-4 pb-20">
        ...
        {history.map((item) => (
          <div key={item.id} className="bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden active:scale-[0.98] transition-all cursor-pointer">
            <div className="p-6">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                 ...
                 <button className="flex items-center gap-2 bg-teal-50 text-teal-600 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest active:scale-95 transition-all">
