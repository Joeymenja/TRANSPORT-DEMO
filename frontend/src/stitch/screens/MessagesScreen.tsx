        ...
        <div className="flex gap-2">
          {['all', 'dispatch', 'system'].map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-teal-500 text-white shadow-lg shadow-teal-100' : 'bg-gray-50 text-gray-500 hover:bg-gray-100'}`}
            >
              {tab}
            </button>
          ))}
