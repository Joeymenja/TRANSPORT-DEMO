  ...
  if (submitted) {
    return (
      <div className="fixed inset-0 z-[70] bg-white flex flex-col items-center justify-center p-12 text-center max-w-md mx-auto h-screen">
        <div className="w-24 h-24 bg-green-50 text-green-500 rounded-[32px] flex items-center justify-center mb-6 duration-500">
          <Check size={48} />
        </div>
        ...
        <button 
          onClick={onBack}
          className="w-full bg-sky-500 text-white font-black py-5 rounded-[32px] shadow-2xl shadow-sky-200 active:scale-95 transition-all"
        >
    ...
    <div className="fixed inset-0 z-[70] bg-gray-50 flex flex-col max-w-md mx-auto h-screen">
      ...
      <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-8 pb-32">
          ...
          <div className="grid grid-cols-2 gap-3">
             <div className="space-y-1">
                ...
                <div className="relative">
                   ...
                   <input required type="date" className="w-full pl-11 pr-4 py-4 bg-white border border-gray-100 rounded-[24px] shadow-sm font-bold text-gray-700 text-sm focus:border-sky-500" />
                </div>
             </div>
             <div className="space-y-1">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
             <select 
               ...
               className="w-full px-6 py-5 bg-white border border-gray-100 rounded-[24px] shadow-sm font-bold text-gray-700 text-sm appearance-none focus:border-sky-500"
             >
             ...
             <textarea 
               ...
               className="w-full px-6 py-5 bg-white border border-gray-100 rounded-[32px] shadow-sm font-medium text-gray-700 text-sm min-h-[150px] focus:border-sky-500"
             />
          </div>
        </section>
        ...
        <div className="fixed bottom-0 left-0 right-0 p-6 bg-white border-t border-gray-50 max-w-md mx-auto">
          <button 
            type="submit"
            className="w-full bg-sky-500 text-white font-black py-5 rounded-[32px] shadow-2xl shadow-sky-200 text-lg active:scale-95 transition-all flex items-center justify-center gap-2"
          >
