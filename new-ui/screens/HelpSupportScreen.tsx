      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-8 pb-10">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="w-full pl-12 pr-4 py-4 bg-white border border-gray-100 rounded-[24px] shadow-sm font-medium text-sm focus:border-sky-500 transition-all"
          />
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { label: 'Chat', icon: MessageSquare, color: 'text-sky-500', bg: 'bg-sky-50' },
        ...
        <section className="space-y-4">
          ...
          <button className="w-full flex items-center justify-center gap-2 text-sky-500 font-black text-xs uppercase tracking-widest py-2">
        ...
        <div className="text-center pt-10 pb-6 opacity-40">
           <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em]">GVBH TRANSPORTATION v1.2.3 (441)</p>
