      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-6 pb-32">
        <div className="bg-gray-900 rounded-[48px] p-8 text-white shadow-2xl relative overflow-hidden">
           <div className="relative z-10 space-y-4">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-sky-400">Total Units Submitted</p>
              ...
              <div className="flex gap-4 pt-4">
                 ...
                 <div className="bg-sky-500/20 px-4 py-2 rounded-2xl border border-sky-500/20">
                    ...
                    <p className="text-xs font-black text-sky-100">4 Units</p>
                 </div>
              </div>
           </div>
        </div>
        ...
        <div className="bg-white rounded-[40px] p-8 shadow-sm border border-gray-100 space-y-6">
           <div className="flex items-center justify-between">
              ...
              <button onClick={fetchInsight} className="p-2 bg-sky-50 text-sky-500 rounded-xl">
